...
OPENAI_API_KEY = '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'
...
# 'test_id', 'HR', 'O2Sat', 'Temp', 'SBP', 'MAP', 'DBP', 'Resp', 'EtCO2', 'BaseExcess', 'HCO3', 'FiO2', 'PaCO2', 'SaO2', 'AST', 'BUN', 'Alkalinephos', 'Calcium', 'Glucose', 'Bilirubin_total', 'Hgb', 'Platelets', 'SepsisLabel'
...
def main():
    ...
    st.dataframe(df_specifics, height=270, width=1800)
